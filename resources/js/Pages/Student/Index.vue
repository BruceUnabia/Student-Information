        ...
        <template #header>
            <div class="flex justify-between">
                ...
                <div style="position:relative">
                    <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-9 p-2.5" placeholder="Search suppliers here" @keydown.enter="search($event)">
